...
for n_image,idx in enumerate(range(0,target_imgs.shape[0])):
    ...
    st = validation_patches[idx][0].replace("ROI2017_winter_s2_val_patches/ROI2017_winter_s2/s2_1","dfc_1").replace("ROIs13_high_roshan_s2_val_patches/ROIs13_high_roshan/s2_1","ROI2017_winter_dfc_val_patches\ROI2017_winter\dfc_1").replace("s2","dfc").replace(".npy",".tif")
    print(st)
